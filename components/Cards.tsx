...
export const FeaturedCard = ({item:{image,rating, name, address, price}, onPress }: FeaturedCardProps) => {
  return (
    <TouchableOpacity
      onPress={onPress}
...
export const Card = ({item:{image,rating, name, address, price},onPress}:FeaturedCardProps) => {
  return (
